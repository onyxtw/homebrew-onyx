class OnyxAccelerator < Formula
  ...
  sha256 " b2aba7219a193bdccfd3ff616ac21b0add19a536b110e9675dae710ce2508b6f  ONYX-ACCELERATOR-1.0.0.tar.gz"
  license "MIT"

  depends_on "cloudflare-warp"
  depends_on "aria2"
